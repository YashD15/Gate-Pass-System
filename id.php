...
imagettftext($new_image, 10, 0, 292, 140, $text_color, $font, $date);
imagettftext($new_image, 10, 0, 292, 160, $text_color, $font, $time);
imagettftext($new_image, 8, 0, 5, 12, $text_color, $font, $id);
imagettftext($new_image, 14, 0, 30, 330, $text_color, $font, "Purpose:-    ".$purpose);
